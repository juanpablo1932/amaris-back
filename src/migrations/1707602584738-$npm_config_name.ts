...
export class $npmConfigName1707602584738 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO patients (email, full_name, password) VALUES ('patient-amaris@test.com', 'Alan Brito', 'test123')`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `INSERT INTO doctors (full_name) VALUES ('Armando Casas')`
    );
    await queryRunner.query(
      `INSERT INTO doctors (full_name) VALUES ('Aquiles Brinco')`
    );
    await queryRunner.query(
